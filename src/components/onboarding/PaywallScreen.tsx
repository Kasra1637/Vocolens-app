    ...
    <View style={{ paddingHorizontal: 24, gap: 8 }}>
      {BENEFITS.map((benefit) => {
        ...
        return (
          ...
          >
            <View style={{ width: 40, height: 40, borderRadius: 13, backgroundColor: 'rgba(255,255,255,0.18)', alignItems: 'center', justifyContent: 'center', marginRight: 14, flexShrink: 0 }}>
...
function BenefitsCarousel({ themeColors }: { themeColors: typeof THEME_COLORS[keyof typeof THEME_COLORS] }) {
...
const BENEFITS = [
  {
    icon: Moon,
    title: 'Better Sleep',
    description: 'Voice journaling before bed clears mental chatter, helping you fall asleep faster and wake up refreshed.',
  },
  {
    icon: Smile,
    title: 'Improved Mood',
    description: 'Daily emotional check-ins create awareness of your mood patterns, giving you tools to shift your state.',
  },
  {
    icon: Brain,
    title: 'Reduced Anxiety',
    description: 'Expressing thoughts out loud reduces the mental load of worry, quieting your anxious mind.',
  },
  {
    icon: BookOpen,
    title: 'Enhanced Self-Reflection',
    description: 'AI-powered insights reveal patterns in your entries you might never have noticed on your own.',
  },
  {
    icon: Heart,
    title: 'Better Emotional Awareness',
    description: 'Track how you feel over time and discover what truly impacts your emotional wellbeing.',
  },
  {
    icon: Mic,
    title: 'Always-On Transcription',
    description: 'The most persistent and reliable voice transcription service on the market — always ready when you are.',
  },
  {
    icon: Activity,
    title: 'Voice Intelligence',
    description: 'The only voice journaling app that uses your voice pace, speed, and tone to analyze and improve your life.',
  },
];
        ...
        <SafeAreaView style={{ flex: 1 }}>
          ...
          >
            ...
            {selectedPlan === 'yearly' && (
              <Animated.View
                ...
                style={{ marginHorizontal: 24, borderRadius: 24, padding: 20, marginBottom: 20, backgroundColor: 'rgba(255,255,255,0.13)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.22)' }}
              >
          ...
          >
            ...
            <View style={{ gap: 10, marginBottom: 14 }}>
              ...
              {/* ── Yearly — hero card ── */}
              <Animated.View style={[yearlyAnimStyle, { width: '95%', alignSelf: 'center' }]}>
                <Pressable
                  onPress={() => handleSelectPlan('yearly')}
                  style={{
                    borderRadius: 20,
                    borderWidth: selectedPlan === 'yearly' ? 2.5 : 1.5,
                    borderColor: selectedPlan === 'yearly' ? '#FFFFFF' : 'rgba(255,255,255,0.32)',
                    backgroundColor: selectedPlan === 'yearly' ? 'rgba(255,255,255,0.20)' : 'rgba(255,255,255,0.07)',
                    padding: 16,
                  }}
                >
              ...
              <Animated.View style={monthlyAnimStyle}>
                <Pressable
                  ...
                  style={{
                    ...
                    borderColor: selectedPlan === 'monthly' ? '#FFFFFF' : 'rgba(255,255,255,0.28)',
                    backgroundColor: selectedPlan === 'monthly' ? 'rgba(255,255,255,0.18)' : 'rgba(255,255,255,0.06)',
                    paddingVertical: 13,
