...
export default function EmotionCorrectionModal({
  ...
  const [step, setStep] = useState<"initial" | "replace" | "explain">(
    "initial",
  );
  ...
  const [correctionMode, setCorrectionMode] =
    useState<CorrectionMode>("slider");
  const [reason, setReason] = useState("");

  // Voice note mini-recorder state
          ...
          >
                    ...
                    <View>
                      ...
                      >
                        ...
                        >
                          <View
                            style={{
                              width: `${(aiValence + 100) / 2}%`,
                              height: "100%",
                              backgroundColor:
                                aiValence >= 0 ? "#10B981" : "#EF4444",
                              borderRadius: 2,
                            }}
                          />
                        </View>
            ...
            {step === "replace" && (
              <Animated.View entering={FadeInDown.delay(100)}>
                ...
                >
                  No worries — emotions can be hard to pin down. Which label
                  feels more like what you were actually feeling?
                </Text>
                <View
            ...
            {step === "explain" && (
              <Animated.View entering={FadeInDown.delay(100)}>
                ...
                >
                  Is there anything that might help us understand this better
                  next time? {"(Optional)"}
                </Text>
                ...
                {correctionMode === "voice" && (
                  ...
                  >
                    ...
                    {isRecordingVoice ? (
                      ...
                      <Pressable onPress={startVoiceRecording}>
