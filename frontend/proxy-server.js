  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .screen iframe {
      ...
      border: none; border-radius: 54px;
    }
    #loading {
    ...
    @media (max-height: 800px) {
      .phone { transform: scale(0.76); transform-origin: center; }
    }
    @media (max-width: 800px) {
      .layout { flex-direction: column; overflow-y: auto; }
      .phone { transform: scale(0.7); transform-origin: top center; }
      .panel { width: 340px; }
    }
    ...
    <div class="phone">
      <div class="screen">
        <div id="loading">
          ...
          <span class="loading-label">Starting VocoLens…</span>
        </div>
        <iframe src="/app.html"
          id="app-iframe"
    ...
    <div class="panel">
      ...
      <div class="qr-card">
        ...
        <div id="qr-status" class="qr-status ${ready ? 'ready' : 'loading'}">
          ${ready ? '✓ Scan with Expo Go' : '⏳ Starting tunnel…'}
        </div>
        <div id="expo-url" class="expo-url ${ready ? 'show' : ''}">${expoUrl || ''}</div>
      </div>
      ...
      <div class="steps">
        ...
        <div class="step">
          ...
          <div class="step-t">Open Expo Go → tap <strong>Scan QR Code</strong></div>
        </div>
        <div class="step">
          <div class="step-n">3</div>
          <div class="step-t">VocoLens loads natively — mic &amp; all features work</div>
        </div>
      </div>
    </div>
